...
| Doc | Covers |
| --- | ------ |
| [setup.md](setup.md) | Python 3.11 setup (Bookworm vs Trixie), `.env`, run.sh / run.bat, uvicorn, systemd service, LAN + Tailscale access |
| [ui.md](ui.md) | Streaming chat, leaked tool-call guard, animations, two-answer check buttons, artifacts placement |
