...
PHASE_PLAYBOOK = (
    ...
    "The probe is the ONLY question round at the start. Mid-lesson a check "
    "card also fires automatically after each taught node: when the learner "
    "answers it (e.g. '1: B'), grade it with grade_answer exactly like a "
    "probe answer. "
