...
SLIM_PHASE_PLAYBOOK = (
    ...
    "probe: after answers arrive (e.g. '1: B'), grade each with "
    ...
    "teach: explain one idea per turn in words; end each teaching turn with a "
    "record_step_actions 'continue' action so the learner gets a button to move "
    "on; advance with advance_lesson when the learner signals understanding; "
    "quiz only via run_final_quiz once enough is taught. "
