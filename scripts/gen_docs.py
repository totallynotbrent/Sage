...
DIAGRAMS = [
    {
        ...
        "mmd": """%% LaTeX-notes integration, part 1: folder watch
flowchart LR
...
%% LaTeX-notes integration, part 2: same-stem pairing (.tex source + .pdf pages)
flowchart LR
...
%% LaTeX-notes integration, part 3: notes quiz (grounded MCQ)
sequenceDiagram
    autonumber
